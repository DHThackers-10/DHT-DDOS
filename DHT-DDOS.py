...
def dht_intro():
    ...
    console.print(Panel.fit(
        "[green]This tool is for [bold]educational & testing[/bold] use only.\n"
...
# Get target info
def get_target():
    show_banner("DHT-DDOS", "bold green")
    console.print( Align.center(
        Panel.fit(f"[cyan]DHT DDOS[/cyan]\nMade by [bold green]Ali Sabri[/bold green]",
...
def main():
    ...
    try:
        ...
        try:
            webbrowser.open("https://youtube.com/@dht-hackers_10", new=2)
        except:
            console.print("🔗 Visit: https://youtube.com/@dht-hackers_10")
        sys.exit()
